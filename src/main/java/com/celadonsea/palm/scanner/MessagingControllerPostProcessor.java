package com.celadonsea.palm.scanner;
 ...
 * {@link com.celadonsea.palm.annotation.Listener @Listener} annotated methods
 * after the initialization of the bean.
 *
 * @author Rafael Revesz
 * @since 1.0
 * @see MessagingController
 * @see com.celadonsea.palm.annotation.Listener
...
public class MessagingControllerPostProcessor implements BeanPostProcessor {
     ...
     * access message {@link com.celadonsea.palm.client.MessageClient @MessageClient}
     * from the spring context.
     */
    private final ConfigurableListableBeanFactory configurableBeanFactory;

    /**
     * Post processor for process {@link com.celadonsea.palm.annotation.Listener @Listener}
     * annotated methods.
     */
     ...
     * be triggered for scanning the {@link com.celadonsea.palm.annotation.Listener @Listener}
     * annotated methods.
     *
     * @param bean the new bean instance
     ...
     * start the scan of the {@link com.celadonsea.palm.annotation.Listener @Listener}
     * annotated methods.
     *
     * @param bean the new bean instance
     */
